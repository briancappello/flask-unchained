...
class TestInject:
    ...
    def test_correct_sig_for_wrapped_fn_without_explicit_args(self):
        ...
        assert (
            getattr(FunkyService.implicit_funky, "__di_name__")
...
class TestInjectClassMethods:
    ...
    def test_explicit_class_attributes_injection(self):
        from tests._bundles.services_bundle.services import (
            ExplicitArgsForClassAttributes,
            OneService,
        )
...
class TestInjectedClassAttributes:
    ...
    def test_injected_class_attrs_on_extended_service(self):
        ...
        assert isinstance(
            unchained.services.extended_class_attr_service.one_service, OneService
        )
        assert isinstance(
            unchained.services.extended_class_attr_service.two_service, TwoService
        )
        assert isinstance(
            unchained.services.extended_class_attr_service.funky_service, FunkyService
        )
    ...
    def test_injected_class_attrs_on_extended_service_with_same_name_as_base(self):
        ...
        assert isinstance(unchained.services.class_attr_service.two_service, TwoService)
        assert isinstance(
            unchained.services.class_attr_service.funky_service, FunkyService
        )
    ...
    def test_injected_class_attrs_with_init(self):
        ...
        assert isinstance(
            unchained.services.class_attr_service_with_init.one_service, OneService
        )
        assert isinstance(
            unchained.services.class_attr_service_with_init.two_service, TwoService
        )
        assert isinstance(
            unchained.services.class_attr_service_with_init.funky_service, FunkyService
        )
    ...
    def test_injected_class_attrs_extended_and_with_init(self):
        ...
        assert isinstance(
            unchained.services.extended_class_attr_with_init.one_service, OneService
        )
        assert isinstance(
            unchained.services.extended_class_attr_with_init.two_service, TwoService
        )
        assert isinstance(
            unchained.services.extended_class_attr_with_init.three_service, ThreeService
        )
        assert isinstance(
            unchained.services.extended_class_attr_with_init.four_service, FourService
        )
        assert isinstance(
            unchained.services.extended_class_attr_with_init.funky_service, FunkyService
        )
