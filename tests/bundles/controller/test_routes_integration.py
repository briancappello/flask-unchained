...
EXPECTED_DEEP_RESULTS = [
    ...
    (
        "views.simple",
        "/app/pre/users/<int:user_id>/roles/<int:role_id>/simple",
        ["GET"],
    ),
    (
        "another_resource.list",
        "/app/pre/users/<int:user_id>/roles/<int:role_id>/another",
        ["GET"],
    ),
    (
        "another_resource.get",
        "/app/pre/users/<int:user_id>/roles/<int:role_id>/another/<int:id>",
        ["GET"],
    ),
    ...
    (
        "views.three",
        "/app/pre/users/<int:user_id>/roles/<int:role_id>/three",
        ["GET", "POST"],
    ),
    ...
    (
        "views.three",
        "/app/pre/users/<int:user_id>/roles/<int:role_id>/deep/three",
        ["GET", "POST"],
    ),
]
