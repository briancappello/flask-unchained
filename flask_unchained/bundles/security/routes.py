...
routes = lambda: [
    ...
    prefix('/api/v1', [
        controller('/auth', SecurityController, rules=[
            ...
            get('/oauthlogin', SecurityController.oauthlogin,
                endpoint='security_api.oauthlogin'),
            post('/oauthauthorized', SecurityController.oauthauthorized,
                 endpoint='security_api.oauthauthorized'),
        ]),
